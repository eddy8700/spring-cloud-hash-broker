...
public class HashMapServiceBrokerController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/{instanceId}/{key}", method = RequestMethod.PUT)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/{instanceId}/{key}", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/{instanceId}/{key}", method = RequestMethod.DELETE)
